...
CREATE TABLE `savedjob` (
  ...
  KEY `UserID` (`UserID`),
  KEY `JobID` (`JobID`),
  CONSTRAINT `savedjob_ibfk_1` FOREIGN KEY (`UserID`) REFERENCES `user` (`ID`),
  CONSTRAINT `savedjob_ibfk_2` FOREIGN KEY (`JobID`) REFERENCES `job` (`ID`)
...
INSERT INTO `savedjob` VALUES (3,'USER0001','JOB0003'),(4,'USER0002','JOB0001'),(6,'USER0002','JOB0003');
