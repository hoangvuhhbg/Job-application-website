        ...
        try{
            ...
            if(rs1.next()){
                ...
                if (rs.next()) {
                    ...
                    sql = "INSERT INTO USER(ID, name, email, phone, username, password, position, status) values('"+newID+"','"+user.getName()+"', '"+user.getEmail()+"', '"+user.getPhoneNumber()+"', '"+user.getUsername()+"', '"+user.getPassword()+"', 'user', 'private')";
